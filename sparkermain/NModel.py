...
# class AI_Model:
#     def __init__(self, symbol, period='1h', lookback=30, steps_to_predict=10):
#         """
...
#         klines= self.client.get_historical_klines(self.symbol,  self.client.KLINE_INTERVAL_1MINUTE,"3000 minutes ago UTC")
#         #print(klines)
